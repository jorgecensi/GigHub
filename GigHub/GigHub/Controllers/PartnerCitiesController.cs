...
namespace GigHub.Controllers
{
    ...
    public class PartnerCitiesController : Controller
    {
        private readonly IUnitOfWork _unitOfWork;

        public PartnerCitiesController(IUnitOfWork unitOfWork)
        {
        ...
        {
            var partnerCities = _unitOfWork.Cities.GetAllCities().Where(c => c.IsPartner).ToList();
